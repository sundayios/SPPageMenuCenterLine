...
//    self.scrollView.scrollEnabled = false;
    /////////设置标题之间分割线 只需设置分割线的颜色   如果不设置分割线颜色，则不显示中间分割线
    pageMenu.spaceLineColor = [UIColor grayColor];
    ////////////设置中间分割线距离边界的长度默认是6
    pageMenu.spaceLineMargin = 10;
...
- (void)test18 {
    self.dataArr = @[@"生活aaa",@"影视中心",@"交通aaa",@"电视剧",@"搞笑",@"综艺"];
